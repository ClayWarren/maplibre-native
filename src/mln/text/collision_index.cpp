...
// The tile border checks below are only well defined when the tile boundaries
// are axis-aligned We are relying on it only being used in MapMode::Tile, where
